<?php
// SMSC.RU API (smsc.ru) версия 3.6 (25.08.2017)

define("SMSC_LOGIN", $smsc_user_name);          // логин клиента
define("SMSC_PASSWORD", $smsc_user_password);    // пароль или MD5-хеш пароля в нижнем регистре
define("SMSC_POST", 1);                 // использовать метод POST
define("SMSC_HTTPS", 1);                // использовать HTTPS протокол
