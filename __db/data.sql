...
INSERT INTO EVENT_TYPE(CODE, NAME, DESCR) VALUES
('ALARM', 'Авариайное сообщение', 'Авариайное сообщение');
INSERT INTO EVENT_TYPE(CODE, NAME, DESCR) VALUES
('SMS', 'Сообщение', 'Сообщение');
...
INSERT INTO USER(LOGIN, PASSWORD, NAME, EMAIL, ROLE_ID) VALUES
('phantick', '1qaz2wsx', 'Dmitry Minkin', 'phantick@gmail.com', (SELECT ID FROM ROLE WHERE CODE = 'ADMIN'));
INSERT INTO USER(LOGIN, PASSWORD, NAME, EMAIL, ROLE_ID) VALUES
('buster', '1qaz2wsx', 'Vladimir Nikishin', 'v.a.nikishin@gmail.com ', (SELECT ID FROM ROLE WHERE CODE = 'ADMIN'));
INSERT INTO USER(LOGIN, PASSWORD, NAME, EMAIL, ROLE_ID) VALUES
('user', '1qaz2wsx', 'Василий Пупкин', 'pupkin@gmail.com', (SELECT ID FROM ROLE WHERE CODE = 'USER'));
